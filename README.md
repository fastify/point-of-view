...
To utilize [`html-minifier`](https://www.npmjs.com/package/html-minifier) in the rendering process, except for the 'pug' engine and streams, you can add the option useHtmlMinifier with a reference to html-minifier,
